...
public class WorkspaceController {
    ...
    @Operation(summary = "워크스페이스 생성 (관리자)", description = "워크스페이스 생성하는 API")
   ...
   @Operation(summary = "워크스페이스 수정 (관리자 or 소유자)", description = "워크스페이스 정보 및 속해 있는 사용자의 추가/삭제/권한변경 API")
   public ResponseEntity<Map<String, Object>> updateWorkspace(
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "워크스페이스 삭제 (관리자)", description = "해당ID의 워크스페이스 삭제하는 API")
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "워크스페이스 ID로 조회 (관리자)", description = "워크스페이스 ID로 조회하는 API")
    ...
    @GetMapping
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "모든 워크스페이스 조회 (관리자)", description = "모든 워크스페이스 조회하는 API")
    ...
    @GetMapping("/search")
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "워크스페이스 이름으로 조회 (관리자)", description = "워크스페이스 이름으로 조회하는 API")
